# Author: @ar3792
"""
Small U-Net: Adpated from U-Net. Highly regularized and half the number of hidden neurons and smaller number of conv layers to prevent
overfitting
"""
import os
import sys
...
checkpointer = ModelCheckpoint('model_2-dsbowl2018-1_50_epochs.h5', verbose=1, save_best_only=True)
results = model_2.fit(X_train, Y_train, validation_split=0.1, batch_size=4, epochs=50, 
