# Author: @ar3792
"""
SAvg-Net : Simple Average of U-Net and Small-U-Net
...
def get_savg_net_model(models,mode_input):
...
ensemble_model= get_savg_net_model(models,model_input)

#SAvg-net doesn't require any extra training
...
ensemble_model.evaluate(X_test*255.0,Y_test) #Multiplied by 255 to account for scale
